...
public class Hauptmenue_Ver05
{
    ...
    public static void main(String[] args) throws Exception 
    {
        ...
        AppPanel mainpanel = new AppPanel(0, 0, frame.getHeight(), frame.getWidth(), AppColor.BLAU);
        frame.add(mainpanel);

        JSeparator[] MainSeperator = new JSeparator[3];

        MainSeperator[0] = new JSeparator();
        MainSeperator[0].setBounds(rand, (int) round(h*0.1), b-2*rand, 400);
        mainpanel.add(MainSeperator[0]);
